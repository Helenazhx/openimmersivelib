...
public struct StreamModel: Codable {
    ...
    public init(title: String, details: String, url: URL, fallbackFieldOfView: Float = 180.0, forceFieldOfView: Float? = nil, isSecurityScoped: Bool = false, isSBS: Bool = false) {
        self.title = title
